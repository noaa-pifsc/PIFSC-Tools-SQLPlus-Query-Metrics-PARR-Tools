...
if ! test -f ../data_exports/parr-tools-query-metrics.csv; then
	# the file does not exist, create it:
	echo "\"DB Name\",\"DB Location\",\"App Location\",\"Query Name\",\"Date/Time\",\"Cost\",\"# Rows\",\"SQL\",\"Response Time (s)\",\"Result Set Size (bytes)\"" > ../data_exports/parr-tools-query-metrics.csv
...
sed -i -e "s/\[FILE_SIZE\]/$filesize/g" ../data_exports/parr-tools-query-metrics.csv
